...
LIBTINYXML2     = "libtinyxml2.so"
LIBTINYXML2_V34 = "libtinyxml2-v34.so"
...
# Commit 7f625f53: libtinyxml2 10.1.0 (landed in BP4A) has ABI-incompatible
# changes that cause runtime crashes; patch affected blobs to use the
# versioned libtinyxml2-v34.so instead.
BLOBS_NEEDING_TINYXML2_V34 = {
...
def blob_fixup(blob_path: str, file_path: str) -> bool:
    ...
    if blob_path in BLOBS_NEEDING_TINYXML2_V34:
        if file_path == "":
            return True
        subprocess.run(
            [PATCHELF, "--replace-needed", LIBTINYXML2, LIBTINYXML2_V34, file_path],
            check=True,
        )
        return True
